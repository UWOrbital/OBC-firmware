...
/**
 * @brief waits for a COMMS_MANAGER_BEGIN_UPLINK_EVENT_ID event to be sent and
 * starts RX and sends the packet to the decode data pipeline queue
 *
...
#endif
#else
        // switch cc1120 to receive mode and start receiving all the bytes for
