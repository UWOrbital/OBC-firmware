 ...
 * @return obc_error_code_t OBC_ERR_CODE_SUCCESS if it was successful and error code if not
 */
static obc_error_code_t sFrameRecv(unstuffed_ax25_packet_t *unstuffedPacket, uint8_t *uplinkData,
 ...
 * @return obc_error_code_t OBC_ERR_CODE_SUCCESS if it was successful and error code if not
 */
static obc_error_code_t iFrameRecv(unstuffed_ax25_packet_t *unstuffedPacket, uint8_t *uplinkData,
                                   ax25_addr_t *recvAddress);
