...
typedef enum {
  ...
  /*Errors causing resets 115-125 */
  OBC_ERR_CODE_STACK_CHECK_FAIL = 115,
  OBC_ERR_CODE_FS_FAILURE = 116,
  OBC_ERR_CODE_CMD_EXEC_OBC_RESET = 117,
  OBC_ERR_CODE_ICEPICK_RESET = 118,
  OBC_ERR_CODE_WATCHDOG_RESET = 119,
  OBC_ERR_CODE_CPU_RESET = 120,
  OBC_ERR_CODE_SW_RESET = 121,
  OBC_ERR_CODE_OSC_FAILURE_RESET = 122,
