...
typedef enum {
  ...
  /* ADCS errors 300 - 399 */
  OBC_ERR_CODE_SUN_POSITION_NOT_INITIALIZED = 300,
  OBC_ERR_CODE_SUN_POSITION_JD_OUT_OF_RANGE = 301,
  OBC_ERR_CODE_SUN_POSITION_MGR_READ_FAIL = 302,
  OBC_ERR_CODE_SUN_POSITION_MGR_WRITE_FAIL = 303,
  OBC_ERR_CODE_SUN_POSITION_MGR_SEARCH_TIMEOUT = 304,  // The binary search took too long

  OBC_ERR_CODE_SUN_POSITION_NOT_IMPLEMENTED = 399,  // Will be removed
  /* EPS errors 400 - 499 */
