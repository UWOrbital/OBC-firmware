...
typedef enum {
  ...
  // Sun Position errors
  OBC_ERR_CODE_SUN_POSITION_NOT_INITIALIZED = 320,
  OBC_ERR_CODE_SUN_POSITION_JD_OUT_OF_RANGE = 321,
  OBC_ERR_CODE_SUN_POSITION_MGR_READ_FAIL = 322,
  OBC_ERR_CODE_SUN_POSITION_MGR_WRITE_FAIL = 323,
