...
static const obc_persist_config_t obcPersistConfig[] = {
    ...
    [OBC_PERSIST_SECTION_ID_STATE_MGR] = {.sectionStartAddr = OBC_PERSIST_ADDR_OF(stateMgr),
                                          .sectionSize = sizeof(state_mgr_persist_t),
                                          .dataSize = sizeof(state_mgr_persist_data_t),
                                          .sectionCount = OBC_PERSISTENT_MIN_SUBINDEX},
};
