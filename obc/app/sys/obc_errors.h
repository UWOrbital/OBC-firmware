...
typedef enum {
  ...
  OBC_ERR_CODE_INVALID_ARG = 1,
  OBC_ERR_CODE_BUFF_TOO_SMALL = 2,
  OBC_ERR_CODE_LOG_MSG_SILENCED = 3,
  OBC_ERR_CODE_INVALID_STATE = 4,
  OBC_ERR_CODE_QUEUE_FULL = 5,

  /* Common Errors 50 - 99 */
  OBC_ERR_CODE_UNKNOWN = 50,
  OBC_ERR_CODE_MUTEX_TIMEOUT = 51,
  OBC_ERR_CODE_UNSUPPORTED_EVENT = 52,
  OBC_ERR_CODE_BUFF_OVERFLOW = 53,
  OBC_ERR_CODE_SEMAPHORE_TIMEOUT = 54,
  OBC_ERR_CODE_SEMAPHORE_FULL = 55,
  OBC_ERR_CODE_QUEUE_EMPTY = 56,
  OBC_ERR_CODE_NOT_MUTEX_OWNER = 57,
  OBC_ERR_CODE_PERSISTENT_CORRUPTED = 58,
  OBC_ERR_CODE_FAILED_UNPACK = 59,
  OBC_ERR_CODE_FAILED_PACK = 60,
  OBC_ERR_CODE_INVALID_STATE_TRANSITION = 61,
  OBC_ERR_CODE_FREERTOS_ASSERT_FAIL = 62,
