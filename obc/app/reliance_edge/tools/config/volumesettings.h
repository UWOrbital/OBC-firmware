...
class VolumeSettings : QObject {
 ...
 public:
  ...
  class Volume {
   public:
    Volume(QString name, WarningBtn *wbtnPathPrefix, WarningBtn *wbtnSectorSize, WarningBtn *wbtnVolSize,
           WarningBtn *wbtnVolOff, WarningBtn *wbtnInodeCount, WarningBtn *wbtnAtomicWrite,
           WarningBtn *wbtnDiscardSupport, WarningBtn *wbtnBlockIoRetries);
  ...
  ///
  VolumeSettings(QLineEdit *pathPrefixBox, QComboBox *sectorSizeBox, QCheckBox *sectorSizeAuto, QSpinBox *volSizeBox,
                 QCheckBox *volSizeAuto, QLabel *volSizeLabel, QSpinBox *volOffBox, QLabel *volOffLabel,
                 QSpinBox *inodeCountBox, QCheckBox *inodeCountAuto, QComboBox *atomicWriteBox,
                 QComboBox *discardSupportBox, QCheckBox *enableRetriesCheck, QSpinBox *numRetriesBox,
                 QWidget *numRetriesWidget, QPushButton *addButton, QPushButton *removeButton, QListWidget *volumesList,
                 WarningBtn *volCountWarn, WarningBtn *pathPrefixWarn, WarningBtn *sectorSizeWarn,
                 WarningBtn *volSizeWarn, WarningBtn *volOffWarn, WarningBtn *inodeCountWarn,
                 WarningBtn *atomicWriteWarn, WarningBtn *discardSupportWarn, WarningBtn *ioRetriesWarn);
  ~VolumeSettings();
  ...
  ///
  void ParseCodefile(const QString &text, QStringList &notFound, QStringList &notParsed);
 ...
 private:
  ...
  template <typename T>
  void parseAndSet(Setting<T> *setting, const QString &value, QStringList &notParsed, const QString &humanName);
