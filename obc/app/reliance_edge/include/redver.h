...
*/
    ...
    ((REDCONF_POSIX_OWNER_PERM == 1) || (REDCONF_DELETE_OPEN == 1) || (REDCONF_API_POSIX_SYMLINK == 1))
...
#define RED_DISK_LAYOUT_IS_VALID(ver) \
  (((ver) == RED_DISK_LAYOUT_ORIGINAL) || ((ver) == RED_DISK_LAYOUT_DIRCRC) || ((ver) == RED_DISK_LAYOUT_POSIXIER))
