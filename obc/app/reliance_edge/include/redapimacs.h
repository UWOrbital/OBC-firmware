...
#define RED_MOUNT_MASK                                                                                      \
  (RED_MOUNT_READONLY | (((REDCONF_READ_ONLY == 0) && (RED_KIT != RED_KIT_GPL)) ? RED_MOUNT_DISCARD : 0U) | \
...
#define RED_TRANSACT_MASK                                                                               \
  (RED_TRANSACT_SYNC | RED_TRANSACT_UMOUNT | RED_TRANSACT_CREAT |                                       \
   ...
   ((REDCONF_API_POSIX_LINK == 1) ? RED_TRANSACT_LINK : 0U) | RED_TRANSACT_CLOSE | RED_TRANSACT_WRITE | \
   RED_TRANSACT_FSYNC | ((REDCONF_API_POSIX_FTRUNCATE == 1) ? RED_TRANSACT_TRUNCATE : 0U) | RED_TRANSACT_VOLFULL)
 ...
 */
#define RED_TRANSACT_MASK                                                                                      \
  (RED_TRANSACT_UMOUNT | RED_TRANSACT_WRITE | ((REDCONF_API_FSE_TRUNCATE == 1) ? RED_TRANSACT_TRUNCATE : 0U) | \
