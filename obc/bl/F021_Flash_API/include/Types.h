...
*/
typedef enum { Fapi_MasterCpu, Fapi_SlaveCpu0 } ATTRIBUTE_PACKED Fapi_CpuSelectorType;
...
*/
typedef enum { Fapi_FLEP = 0, Fapi_FLEE = 1, Fapi_FLES = 2, Fapi_FLHV = 3 } ATTRIBUTE_PACKED Fapi_FlashBankTechType;
...
/*!
    \brief This contains all the possible Flash State Machine commands.
*/
typedef enum { Fapi_NormalRead = 0x0, Fapi_RM0 = 0x1, Fapi_RM1 = 0x2 } ATTRIBUTE_PACKED Fapi_FlashReadMarginModeType;
