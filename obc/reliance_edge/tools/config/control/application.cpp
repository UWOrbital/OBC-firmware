...
int Application::Run() {
  ...
  connect(configWindow, SIGNAL(saveClicked()), this, SLOT(TrySave()));
  connect(configWindow, SIGNAL(saveAsClicked()), this, SLOT(TrySaveAs()));
  connect(output, SIGNAL(results(Output::Result, QString, QString)), this,
          SLOT(output_results(Output::Result, QString, QString)));
  connect(configWindow, SIGNAL(loadClicked()), this, SLOT(TryLoad()));
  connect(input, SIGNAL(results(Input::Result, QString, QString)), this,
          SLOT(input_results(Input::Result, QString, QString)));
  connect(configWindow, SIGNAL(warningBtnClicked()), this, SLOT(ShowErrors()));
