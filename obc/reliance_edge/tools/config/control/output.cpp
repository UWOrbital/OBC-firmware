...
Output::Output(QWidget *parentWin)
  ...
  connect(errorDialog, SIGNAL(results(ErrorDialog::Result)), this, SLOT(errorDialog_results(ErrorDialog::Result)));
}
...
void Output::doOutput() {
  ...
  const QString headMessage = QString(
      ...
      "    DO NOT MODIFY.\n"
      "\n"
      "    Generated by configuration utility version " +
  ...
  if (!success) {
    success = true;
    if (fileDialog == NULL) {
      fileDialog = new FileDialog(parentWindow, QFileDialog::AcceptSave, QFileDialog::AnyFile);
    }
