...
#define DELETE_SUPPORTED                                                                              \
  ((REDCONF_READ_ONLY == 0) &&                                                                        \
   ((REDCONF_API_POSIX == 1) && ((REDCONF_API_POSIX_RMDIR == 1) || (REDCONF_API_POSIX_UNLINK == 1) || \
                                 ((REDCONF_API_POSIX_RENAME == 1) && (REDCONF_RENAME_ATOMIC == 1)))))

#define TRUNCATE_SUPPORTED                                                                          \
  ((REDCONF_READ_ONLY == 0) && (((REDCONF_API_POSIX == 1) && (REDCONF_API_POSIX_FTRUNCATE == 1)) || \
...
#define DISCARD_SUPPORTED      \
  ((REDCONF_READ_ONLY == 0) && \
   (((REDCONF_API_POSIX == 1) && (REDCONF_API_POSIX_FSTRIM == 1)) || (REDCONF_DISCARDS == 1)))
