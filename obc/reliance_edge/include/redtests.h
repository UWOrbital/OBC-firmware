...
#define FSSTRESS_SUPPORTED                                                                                            \
  (((RED_KIT == RED_KIT_GPL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) && (REDCONF_READ_ONLY == 0) && \
   (REDCONF_PATH_SEPARATOR == '/') && (REDCONF_API_POSIX == 1) && (REDCONF_API_POSIX_UNLINK == 1) &&                  \
   ...
   (REDCONF_API_POSIX_CWD == 1))

#define FSE_STRESS_TEST_SUPPORTED                                                                \
  (((RED_KIT == RED_KIT_COMMERCIAL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) && \
   (REDCONF_READ_ONLY == 0) && (REDCONF_API_FSE == 1) && (REDCONF_API_FSE_FORMAT == 1) &&        \
   (REDCONF_API_FSE_TRANSMASKSET == 1) && (REDCONF_API_FSE_TRANSMASKGET == 1) && (REDCONF_API_FSE_TRUNCATE == 1))

#define POSIX_API_TEST_SUPPORTED                                                                 \
  (((RED_KIT == RED_KIT_COMMERCIAL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) && \
   (REDCONF_READ_ONLY == 0) && (REDCONF_API_POSIX == 1) && (REDCONF_API_POSIX_FORMAT == 1) &&    \
...
#define STOCH_POSIX_TEST_SUPPORTED                                                                         \
  (((RED_KIT == RED_KIT_COMMERCIAL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) &&           \
   ...
   (REDCONF_API_POSIX_UNLINK == 1) && (REDCONF_API_POSIX_RENAME == 1) && (REDCONF_NAME_MAX >= 9U))
...
#define DISKFULL_TEST_SUPPORTED                                                                  \
  (((RED_KIT == RED_KIT_COMMERCIAL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) && \
   (REDCONF_READ_ONLY == 0) && (REDCONF_API_POSIX == 1) && (REDCONF_API_POSIX_FORMAT == 1) &&    \
   (REDCONF_API_POSIX_FTRUNCATE == 1) && (REDCONF_API_POSIX_UNLINK == 1) && (REDCONF_API_POSIX_LINK == 1))

#define MVSTRESSTEST_SUPPORTED                                                                   \
  (((RED_KIT == RED_KIT_COMMERCIAL) || (RED_KIT == RED_KIT_SANDBOX)) && (REDCONF_OUTPUT == 1) && \
   (REDCONF_READ_ONLY == 0) && (REDCONF_NAME_MAX >= 8U) && (REDCONF_API_POSIX == 1) &&           \
   (REDCONF_API_POSIX_FORMAT == 1) && (REDCONF_API_POSIX_FTRUNCATE == 1) && (REDCONF_API_POSIX_UNLINK == 1))
...
PARAMSTATUS RedStochPosixParseParams(int argc, char *argv[], STOCHPOSIXPARAM *pParam, uint8_t *pbVolNum,
                                     const char **ppszDevice);
...
PARAMSTATUS FseStressParseParams(int argc, char *argv[], FSESTRESSPARAM *pParam, uint8_t *pbVolNum,
                                 const char **ppszDevice);
...
PARAMSTATUS RedPosixTestParseParams(int argc, char *argv[], POSIXTESTPARAM *pParam, uint8_t *pbVolNum,
                                    const char **ppszDevice);
...
PARAMSTATUS RedFseTestParseParams(int argc, char *argv[], FSETESTPARAM *pParam, uint8_t *pbVolNum,
                                  const char **ppszDevice);
...
PARAMSTATUS FSIOTestParseParams(int argc, char *argv[], FSIOTESTPARAM *pParam, uint8_t *pbVolNum,
                                const char **ppszDevice);
...
PARAMSTATUS BDevTestParseParams(int argc, char *argv[], BDEVTESTPARAM *pParam, uint8_t *pbVolNum,
                                const char **ppszDevice);
...
PARAMSTATUS DiskFullTestParseParams(int argc, char *argv[], DISKFULLTESTPARAM *pParam, uint8_t *pbVolNum,
                                    const char **ppszDevice);
