...
REDSTATUS RedOsMutexInit(void) {
  ...
  /* Returns  success always since baremetal is single threaded, no need for mutexes */
...
/** @brief Acquire the mutex.
    ...
    undefined.
*/
void RedOsMutexAcquire(void) { /* Do nothing since baremetal is single threaded, no need for mutexes */
}
...
/** @brief Release the mutex.
    ...
    - Releasing the mutex from a task or thread other than the one which
      acquired the mutex.
*/
void RedOsMutexRelease(void) { /* Do nothing since baremetal is single threaded, no need for mutexes*/
}
