...
#define INA230_EM_ALERT_LATCH_DISABLE_MASK (0x0000)

#define INA230_CONFIG_MODE_MASK (0b111)
#define INA230_CONFIG_SHU_MASK (0b100 << 3)
...
obc_error_code_t initINA230Interface() {
  ...
  uint16_t configRegister = INA230_CONFIG_MODE_MASK | INA230_CONFIG_SHU_MASK | INA230_CONFIG_AVG_MASK;
