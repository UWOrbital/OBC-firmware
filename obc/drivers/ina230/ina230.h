 ...
 * @param busVoltCT Conversion time for bus voltage measurement in microseconds
 * @param shuntVoltCT Conversion time for shunt voltage measurement in microseconds
