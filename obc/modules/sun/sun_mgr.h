 ...
 * @attention Requires buffer and manager are valid pointers; julianDate is greater or equal to the min julian date stored in manager;
 ...
 * @attention Manager must be a valid pointer; JD of data must be greater than the JD of the last data point in the manager
