...
#define TASK_PWR_MGR_WATCHDOG_TIMEOUT portMAX_DELAY
...
#define TASK_POWER_MGR_WATCHDOG_TIMEOUT portMAX_DELAY
...
static watchdog_task_info_t watchdogTaskArray[] = {
    ...
    [OBC_SCHEDULER_CONFIG_ID_PWR_MGR] =
        {
            .taskTimeoutTicks = TASK_PWR_MGR_WATCHDOG_TIMEOUT,
        },
    ...
    [OBC_SCHEDULER_CONFIG_ID_POWER_MGR] =
        {
            .taskTimeoutTicks = TASK_POWER_MGR_WATCHDOG_TIMEOUT,
        },
