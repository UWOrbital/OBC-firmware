...
//     RETURN_IF_ERROR_CODE(framRead(fram_address, read_buffer,
//     sizeof(fram_adcs_persist_t)));
...
//     //Integrity Check
//     uint32_t crc32 = RedCrc32Update(0, &read_data.data,
//     sizeof(fram_adcs_data_t)); if (read_data.header.len !=
//     sizeof(fram_adcs_data_t)) {
//         // Do something
//         return OBC_ERR_CODE_PERSISTENT_CORRUPTED;
//     }
...
//     //Use CRC32 function from Red to calculate crc
//     write_data.header.crc32 = RedCrc32Update(0, &data,
//     sizeof(fram_adcs_data_t)); write_data.data = data; memcpy(write_buffer,
//     &write_data, sizeof(fram_adcs_persist_t));

//     RETURN_IF_ERROR_CODE(framWrite(fram_address, write_buffer,
//     sizeof(fram_adcs_persist_t))); return OBC_ERR_CODE_SUCCESS;
// }
...
//     //Integrity Check
//     uint32_t crc32 = RedCrc32Update(0, &read_data.data,
//     sizeof(fram_comms_data_t)); if (read_data.header.len !=
//     sizeof(fram_comms_data_t)) {
//         // Do something
//         return OBC_ERR_CODE_PERSISTENT_CORRUPTED;
//     }
...
//     //Use CRC32 function from Red to calculate crc
//     write_data.header.crc32 = RedCrc32Update(0, &data,
//     sizeof(fram_comms_data_t)); write_data.data = data; memcpy(write_buffer,
//     &write_data, sizeof(fram_comms_persist_t));

//     RETURN_IF_ERROR_CODE(framWrite(fram_address, write_buffer,
//     sizeof(fram_comms_persist_t))); return OBC_ERR_CODE_SUCCESS;
// }
...
//     //Integrity Check
//     uint32_t crc32 = RedCrc32Update(0, &read_data.data,
//     sizeof(fram_eps_data_t)); if (read_data.header.len !=
//     sizeof(fram_eps_data_t)) {
//         // Do something
//         return OBC_ERR_CODE_PERSISTENT_CORRUPTED;
//     }
...
//     //Use CRC32 function from Red to calculate crc
//     write_data.header.crc32 = RedCrc32Update(0, &data,
//     sizeof(fram_eps_data_t)); write_data.data = data; memcpy(write_buffer,
//     &write_data, sizeof(fram_eps_persist_t));

//     RETURN_IF_ERROR_CODE(framWrite(fram_address, write_buffer,
//     sizeof(fram_eps_persist_t))); return OBC_ERR_CODE_SUCCESS;
// }
...
//     //Integrity Check
//     uint32_t crc32 = RedCrc32Update(0, &read_data.data,
//     sizeof(fram_payload_data_t)); if (read_data.header.len !=
//     sizeof(fram_payload_data_t)) {
//         // Do something
//         return OBC_ERR_CODE_PERSISTENT_CORRUPTED;
//     }
...
//     //Use CRC32 function from Red to calculate crc
//     write_data.header.crc32 = RedCrc32Update(0, &data,
//     sizeof(fram_payload_data_t)); write_data.data = data;
//     memcpy(write_buffer, &write_data, sizeof(fram_payload_persist_t));

//     RETURN_IF_ERROR_CODE(framWrite(fram_address, write_buffer,
//     sizeof(fram_payload_persist_t))); return OBC_ERR_CODE_SUCCESS;
// }
