...
typedef enum {
    ...
    CC1120_ERR_CODE_READ_EXT_ADDR_SPI_FAILED = 500,
    CC1120_ERR_CODE_WRITE_EXT_ADDR_SPI_FAILED,
    CC1120_ERR_CODE_INVALID_STATUS_BYTE,
    CC1120_ERR_CODE_TEST_FAILURE = 599,
