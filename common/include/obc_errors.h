...
typedef enum {
    ...
    OBC_ERR_CODE_CAN_TX_DATA_OVERSIZE = 104,
    OBC_ERR_CODE_CAN_FAILURE = 105,
    OBC_ERR_CODE_CAN_MESSAGE_LOST = 106,    
    OBC_ERR_CODE_UNSUPPORTED_CAN_MSG = 107,

    /* CDH errors 200 - 299 */
    OBC_ERR_CODE_UNSUPPORTED_CMD = 200,
    OBC_ERR_CODE_CMD_NOT_ALLOWED = 201,
    OBC_ERR_CODE_SUBSYS_SHUTDOWN_GRANTED = 202,
    OBC_ERR_CODE_SUBSYS_SHUTDOWN_DENIED = 203,
    OBC_ERR_CODE_HEARTBEAT_VALID = 204,
    OBC_ERR_CODE_HEARTBEAT_INVALID = 205,
    OBC_ERR_CODE_TELEMETRY_INVALID = 206,
