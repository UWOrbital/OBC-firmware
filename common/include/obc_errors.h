...
typedef enum {
    ...
    CC1120_ERROR_CODE_INVALID_PARAM = 501,
    CC1120_ERROR_CODE_READ_EXT_ADDR_SPI_FAILED = 502,
    CC1120_ERROR_CODE_WRITE_EXT_ADDR_SPI_FAILED = 503,
    CC1120_ERROR_CODE_INVALID_STATUS_BYTE = 504,
    CC1120_ERROR_CODE_RECV_QUEUE_TIMEOUT = 505
