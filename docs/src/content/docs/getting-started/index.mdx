...
<LinkCard title="Style guide" href="/OBC-firmware/getting-started/style-guide/" />
<LinkCard title="File structure overview" href="/OBC-firmware/getting-started/file-structure/" />
