...
import { selectCommand } from '../selectCommand/selectCommandSlice';
  ...
  if (!selectedCommandName) {
    return (
      <div className="p-4 text-gray-500 text-center">
        <p>Please select a command to configure parameters.</p>
      </div>
    );
  }
  ...
  if (!matchedCommand) {
    return (
      <div className="p-4 text-red-500 text-center">
        <p>Command "{selectedCommandName}" not found in available commands.</p>
      </div>
    );
  }
