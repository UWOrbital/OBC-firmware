...
function AroAdminTable<T>({
  ...
  return (
    <div className={containerClassName}>
      ...
      {/* Table */}
      <div className="bg-gray-900/30 backdrop-blur-sm rounded-lg overflow-x-auto border border-gray-700/50">
            ...
            {table.getRowModel().rows.map((row) => (
              ...
              >
                {row.getVisibleCells().map((cell) => (
                  <td key={cell.id} className="px-6 py-4 text-gray-200 truncate"title={String(cell.getValue())}>
