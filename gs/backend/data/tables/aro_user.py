...
from gs.backend.data.constants import CALL_SIGN_MAX_LENGTH, CALL_SIGN_MIN_LENGTH, DEFAULT_MAX_LENGTH, MIN_EMAIL_LENGTH
...
class AROUsers(BaseSQLModel, table=True):
    ...
    email: EmailStr = Field(min_length=MIN_EMAIL_LENGTH, max_length=DEFAULT_MAX_LENGTH, unique=True)
