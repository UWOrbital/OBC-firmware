...
enum OperateMode { AsynchronousOperate, SynchronousOperate };
...
enum DataBits { DataBits5 = 5, DataBits6 = 6, DataBits7 = 7, DataBits8 = 8 };
...
enum StopBits { StopOne = 0, StopOneAndHalf = 1, StopTwo = 2 };

enum FlowControl { FlowNone = 0, FlowHardware = 1, FlowSoftware = 2 };
...
C_DLL_EXPORT void CSerialPortInit(void *pSerialPort, const char *portName, int baudRate, enum Parity parity,
                                  enum DataBits dataBits, enum StopBits stopbits, enum FlowControl flowControl,
