...
dojoConfig.packages.push({'name': 'codefileviewer_shared', 'location': '/toolbox/matlab/codefileviewer/shared/shared'});
dojoConfig.packages.push({'name': 'codegenwidget-ui', 'location': '/toolbox/matlab/plottools/codegenwidget/codegenwidget-ui'});
...
dojoConfig.packages.push({'name': 'datatools_cfbactions-ui', 'location': '/toolbox/matlab/datatools/matlab_integration/cfbactions/datatools_cfbactions-ui'});
...
dojoConfig.packages.push({'name': 'folder_icon_plugin', 'location': '/toolbox/matlab/filesystem/default_filetype_plugins/folder_icon_plugin/impl'});
dojoConfig.packages.push({'name': 'folder_label_plugin', 'location': '/toolbox/matlab/filesystem/default_filetype_plugins/folder_label_plugin/impl'});
...
dojoConfig.packages.push({'name': 'graderpanel-lib', 'location': '/toolbox/grader/views/panel/graderpanel-lib'});
dojoConfig.packages.push({'name': 'graderui-adapter', 'location': '/derived/toolbox/grader/views/graderui-adapter'});
...
dojoConfig.packages.push({'name': 'livecodefileviewer', 'location': '/toolbox/matlab/codefileviewer/livecode/widget'});
...
dojoConfig.packages.push({'name': 'matlabtest-shared-runtests-settings', 'location': '/toolbox/matlab/testframework/shared/testbrowser/runtestssettings/matlabtest-shared-runtests-settings'});
...
dojoConfig.packages.push({'name': 'mw-storage-service', 'location': '/ui/mw-storage-service'});
...
dojoConfig.packages.push({'name': 'mw-value-engine-utils', 'location': '/ui/mw-value-engine-utils'});
...
dojoConfig.packages.push({'name': 'plaincodefileviewer', 'location': '/toolbox/matlab/codefileviewer/plaincode/widget'});
...
dojoConfig.packages.push({'name': 'project-open-ui', 'location': '/toolbox/matlab/project/views/open_web/project-open-ui'});
...
dojoConfig.packages.push({'name': 'slexec_mm_display-derived', 'location': '/derived/toolbox/simulink/timinglegend'});
...
dojoConfig.packages.push({'name': 'testbrowser-ui', 'location': '/toolbox/matlab/testframework/testbrowser/testbrowser-ui'});
dojoConfig.packages.push({'name': 'testbrowser_datamodel', 'location': '/toolbox/matlab/testframework/testbrowser_datamodel/json'});
...
dojoConfig.packages.push({'name': 'web', 'location': '/toolbox/matlab/codefileviewer/standalone/web/js'});
