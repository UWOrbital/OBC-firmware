...
typedef enum {
  ...
  /* File System errors 500 - 600 */
  OBC_GS_ERR_CODE_FAILED_FILE_OPEN = 500,
  OBC_GS_ERR_CODE_FAILED_FILE_CLOSE = 501,
  OBC_GS_ERR_CODE_FAILED_FILE_WRITE = 502,
