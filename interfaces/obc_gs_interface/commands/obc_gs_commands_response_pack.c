...
typedef obc_error_code_t (*pack_cmd_handler_t)(cmd_unpacked_response_t, uint8_t*, uint32_t*);
...
static const pack_cmd_handler_t packHandlers[] = {[execObCResetCmd] = &packCommandResponse};
