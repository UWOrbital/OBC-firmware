...
// CMD_RTC_TESTS
static void unpackRTCTestData(const uint8_t* buffer, uint32_t* offset, cmd_msg_t* msg);
...
// CMD_RTC_TESTS
static void unpackRTCTestData(const uint8_t* buffer, uint32_t* offset, cmd_msg_t* cmdMsg) {
  // No data to unpack
}
