...
typedef void (*telemetry_pack_func_t)(telemetry_data_t *, uint8_t *, uint32_t *);
...
obc_gs_error_code_t packTelemetry(telemetry_data_t *data, uint8_t *buffer, size_t len, uint32_t *numPacked) {
