                         ...
                         uint8_t *devOperationMode)
{
    ...
    if (i2c_read_register(devAddr, LM75BD_REG_CONF, configBuff, 1) == 0) {
        return 0;
    }
                          ...
                          uint8_t devOperationMode)
{
    ...
    if (i2c_write_register(devAddr, LM75BD_REG_CONF, configBuff, 1) == 0) {
        return 0;
    }
...
uint8_t readThystLM75BD(uint8_t devAddr, float *hysteresisThresholdCelsius) {
    ...
    if (i2c_read_register(devAddr, LM75BD_REG_THYST, tempBuff, 2) == 0) {
        return 0;
    }
...
uint8_t writeThystLM75BD(uint8_t devAddr, float hysteresisThresholdCelsius) {
    ...
    if (i2c_write_register(devAddr, LM75BD_REG_THYST, tempBuff, 2) == 0) {
        return 0;
    }
...
uint8_t readTosLM75BD(uint8_t devAddr, float *overTempThresholdCelsius) {
    ...
    if (i2c_read_register(devAddr, LM75BD_REG_TOS, tempBuff, 2) == 0) {
        return 0;
    }
...
uint8_t writeTosLM75BD(uint8_t devAddr, float overTempThresholdCelsius) {
    ...
    if (i2c_write_register(devAddr, LM75BD_REG_TOS, tempBuff, 2) == 0) {
        return 0;
    }
