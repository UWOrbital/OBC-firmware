...
/**
 * @brief	Initialize the telemetry task and associated FreeRTOS constructs
 * (queues, timers, etc.)
 */
 ...
 * @return  obc_error_code_t OBC_ERR_CODE_SUCCESS if the data was added to the
 * queue, error code otherwise
 */
