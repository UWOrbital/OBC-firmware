 ...
 * @var BSY     Busy. This bit indicates the device is busy executing
 ...
 * @return OBC_ERR_CODE_SUCCESS if the RTC was initialized, appropriate error
 * code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the seconds was accessed, appropriate error
 * code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the minutes was accessed, appropriate error
 * code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the hour was accessed, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the days was accessed, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the date was accessed, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the month was accessed, appropriate error
 * code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if the year was accessed, appropriate error code
 * otherwise.
 */
obc_error_code_t getYearRTC(uint8_t* year);

/**
 * @brief Gets date and time data from RTC by populating rtc_date_time_t struct
 * members.
 *
 * @param dateTime struct pointer to store date and time.
 * @return OBC_ERR_CODE_SUCCESS if the date and time were accessed, appropriate
 * error code otherwise.
 */
obc_error_code_t getCurrentDateTimeRTC(rtc_date_time_t* dateTime);

/**
 * @brief Gets current time data from RTC by populating rtc_date_time_t struct
 * members.
 *
 * @param time struct pointer to store current time.
 * @return OBC_ERR_CODE_SUCCESS if the current time was accessed, appropriate
 * error code otherwise.
 */
obc_error_code_t getCurrentTimeRTC(rtc_time_t* time);

/**
 * @brief Gets current alarm configuration from RTC by populating
 * rtc_alarm_time_t struct members.
 *
 * @param alarmTime struct pointer to store alarm time.
 * @return OBC_ERR_CODE_SUCCESS if the alarm time was accessed, appropriate
 * error code otherwise.
 */
obc_error_code_t getAlarmTimeRTC(rtc_alarm_time_t* alarmTime);

/**
 * @brief Gets current control register configuration from RTC by populating
 * rtc_control_t struct members.
 *
 * @param control struct pointer to store control configuration.
 * @return OBC_ERR_CODE_SUCCESS if control register was accessed, appropriate
 * error code otherwise.
 */
obc_error_code_t getControlRTC(rtc_control_t* control);

/**
 * @brief Gets current status register configuration from RTC by populating
 * rtc_status_t struct members.
 *
 * @param status struct pointer to store status configuration.
 * @return OBC_ERR_CODE_SUCCESS if status register was accessed, appropriate
 * error code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if aging register was accessed, appropriate
 * error code otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if temperature register was accessed,
 ...
 * @return OBC_ERR_CODE_SUCCESS if seconds was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if minutes was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if hours was set, appropriate error code
 * otherwise.
 ...
 * @return OBC_ERR_CODE_SUCCESS if day was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if date was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if month was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if year was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if date and time was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if control was set, appropriate error code
 * otherwise.
 */
 ...
 * @return OBC_ERR_CODE_SUCCESS if status was set, appropriate error code
 * otherwise.
 */
