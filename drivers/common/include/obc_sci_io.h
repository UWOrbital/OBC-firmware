 ...
 * @return OBC_ERR_CODE_SUCCESS on success OBC_ERR_CODE_INVALID_ARG or
 * OBC_ERR_CODE_UNKOWN on fail
 */
...
/**
 * @brief Read a string from UART_READ_REG by polling and store it in the text
 * buffer.
 *
 ...
 * OBC_ERR_CODE_UNKOWN on fail
 *
 * @note Bytes will be read until a newline character or (length - 1) characters
 * are received. A null terminator will be added to the end of the string.
 */
